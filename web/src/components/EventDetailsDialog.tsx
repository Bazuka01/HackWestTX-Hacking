              ...
              <div className="mt-6 flex flex-col gap-2">
                ...
                {onRemove && (
                  <button
                    ...
                    className="w-full cursor-pointer rounded-full border border-[#2E2E2E] py-2.5 text-sm font-semibold text-[#8C8785] transition-colors hover:border-[#DC143C] hover:text-[#DC143C]"
                  >
                    {t.saved.remove}
                  </button>
                )}
